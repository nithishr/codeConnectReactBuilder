                    ...
                    <Row params={ this.props.params } location={ this.props.location }>
                        ...
                        <IndexLink to="/contributor"
                            ...
                            <Button bsStyle="success"
                                    style={ { textAlign: 'center', cssFloat: 'right', paddingLeft: '6%', paddingRight: '6%', marginTop: '0px' } }
                                    bsSize="large"
                                    params={ this.props.params }
                                    location={ this.props.location }>
                                ...
                                <ListGroup fill={ true }
                                    ...
                                    <ListGroupItem href="#"
                                        ...
                                        <Button bsStyle="success"
                                                ...
                                                location={ this.props.location }>
                                            <span params={ this.props.params } location={ this.props.location }>Default</span>
                                        </Button><span params={ this.props.params } location={ this.props.location }>5: Redesign MainMenu</span>
                                    </ListGroupItem>
                                    <ListGroupItem href="#"
                                                   active={ false }
                                                   style={ { minHeight: '50px' } }
                                        ...
                                        <Button bsStyle="success"
                                                ...
                                                location={ this.props.location }>
                                            <span params={ this.props.params } location={ this.props.location }>Default</span>
                                        </Button><span params={ this.props.params } location={ this.props.location }>9: Redesign Icon</span>
                                    </ListGroupItem>
                                    <ListGroupItem href="#"
                                                   active={ false }
                                                   style={ { minHeight: '50px' } }
                                        ...
                                        <Button bsStyle="success"
                                                ...
                                                location={ this.props.location }>
                                            <span params={ this.props.params } location={ this.props.location }>Default</span>
                                        </Button><span params={ this.props.params } location={ this.props.location }>15: Add MuteButton</span>
                                    </ListGroupItem>
                                </ListGroup>
                            </Panel>
                        </Panel>
